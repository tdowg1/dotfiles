...
#alias mypydf='pydf | grep -vP afs\|snap'
#alias mpydf='pydf | grep -vP afs\|snap'
alias pydf='/usr/bin/pydf | grep -vP afs\|snap'
alias pydflocal='/usr/bin/pydf --local | grep -vP afs\|snap'
alias pydfl='/usr/bin/pydf --local | grep -vP afs\|snap'
